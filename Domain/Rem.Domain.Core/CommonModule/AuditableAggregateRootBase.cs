...
{
    /// <summary>
    /// AuditableAggregateRootBase provides a base implementation for aggregate roots. 
    /// </summary>
    public abstract class AuditableAggregateRootBase : AbstractAggregateRoot, IAuditable
    {
