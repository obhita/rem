...
{
    /// <summary>
    /// Resize Mode for FloatableWindow
    /// </summary>
    public enum ResizeMode
    {
        ...
        /// <summary>
        /// Can Resize With Grip
        /// </summary>
        CanResizeWithGrip = 3,
    }

    /// <summary>
    /// Floatable Window class
    /// </summary>
    ...
    public class FloatableWindow : ContentControl, IPopup
    {
        ...
        {
            get { return Application.Current == null ? null : (Application.Current.RootVisual as Control); }
        }
        ...
        public bool IsOpen
        {
            get { return (this.ChildWindowPopup != null && this.ChildWindowPopup.IsOpen); }
        }
        ...
        public void Show ()
        {
            if ( Application.Current.RootVisual != null )
            {
                double screenWidth = ( Application.Current.RootVisual as FrameworkElement ).ActualWidth;
                if ( double.IsNaN ( this.Width ) )
                {
                    _horizontalOffset = screenWidth / 2;
                }
                else if ( screenWidth > this.Width )
                {
                    _horizontalOffset = ( screenWidth - this.Width ) / 2;
                }

                double screenHeight = ( Application.Current.RootVisual as FrameworkElement ).ActualHeight;
                if ( double.IsNaN ( this.Height ) )
                {
                    _verticalOffset = screenHeight / 2;
                }
                else if ( screenHeight > this.Height )
                {
                    _verticalOffset = ( screenHeight - this.Height ) / 2;
                }

                Show ( _horizontalOffset, _verticalOffset );
            }
        ...
        /// <summary>
        /// Shows the specified horizontal offset.
        /// </summary>
        ...
        private void UpdateOverlaySize ()
        {
            if ( _modal )
            {
                if ( this._overlay != null && Application.Current != null && Application.Current.Host != null
